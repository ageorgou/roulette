function [success,totalProb,sample] = FFBS_noisy(P,times,initState,obs,statespace,oldSample)
...
D = 10^-6;
% Use a Euclidean distance from the observed state...
diffs = bsxfun(@minus,statespace(:,2:end),obsVector);
dists = sqrt(sum(diffs.^2,2));
p = 1 ./ (2 .^ dists + D); % ...and a eometric-like observation probability
